...
export const exercises: Exercise[] = [
  ...
  },
  {
    ...
    chapterId: "ch04-06",
    type: "quiz",
    prompt: "cp --help を実行すると、何が表示されますか?",
    choices: [
      "cpコマンドで指定できるオプションと、簡単な使い方の要約",
      "man cp と全く同じ、ページ形式の詳しいマニュアル",
      "cpコマンドの実行ログの一覧",
      "cpコマンドをアンインストールするかどうかの確認",
    ],
    correctChoiceIndex: 0,
    hints: [
      "--help は多くのコマンドに共通して用意されている、簡易的な使い方の確認手段です。",
    ],
    explanation:
      "コマンド --help を実行すると、そのコマンド自身が用意している簡潔な使い方(SYNOPSISやオプション一覧)が表示されます。" +
      "manコマンドによる詳しいマニュアルとは異なり、要点だけを手早く確認したいときに使います。",
  },
  {
    id: "ch04-06-ex127",
    chapterId: "ch04-06",
